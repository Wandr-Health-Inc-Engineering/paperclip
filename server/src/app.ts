...
import { tethrRoutes } from "./routes/tethr.js";
import { initTethr } from "./tethr/index.js";
...
export async function createApp(
  ...
  // Tethr add-on layer (see DECISIONS.md "Core changes"): adapter + routes.
  initTethr(db);
  api.use(tethrRoutes(db));
